          ...
          <div className="sidebar-menu">
            <ul className="menu">
              ...
              <li className="sidebar-item">
                <a href="/resepsionis/dashboard" className="sidebar-link">
                  <i className="bi bi-grid-fill" />
                  <span>Dashboard</span>
                </a>
              </li>
              <li className="sidebar-item">
                <a href="/resepsionis/pengunjung" className="sidebar-link">
                  <i className="bi bi-person-fill" />
                  <span>Pengunjung</span>
                </a>
              </li>
              <li className="sidebar-item">
                <a href="/resepsionis/kamar" className="sidebar-link">

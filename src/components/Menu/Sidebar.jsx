        ...
        <div className="sidebar-menu">
          <ul className="menu">
            ...
            <li className="sidebar-item">
              <a href="/manager/dashboard" className="sidebar-link">
                <i className="bi bi-grid-fill" />
                <span>Dashboard</span>
              </a>
            </li>
            <li className="sidebar-item">
              <a href="/manager/pengunjung" className="sidebar-link">
                <i className="bi bi-person-fill" />
                <span>Pengunjung</span>
              </a>
            </li>
            <li className="sidebar-item">
              <a href="/manager/kamar" className="sidebar-link">
                <i className="bi bi-door-open-fill" />
                <span>Kamar</span>
              </a>
            </li>
            <li className="sidebar-item">
              <a href="/manager/karyawan" className="sidebar-link">
                <i className="bi bi-person-fill" />
                <span>Karyawan</span>
              </a>
            </li>

...
const RoomserviceKamarAdd = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      window.location.href = "/roomservice/kamar";
            ...
            <div className="bg-dark p-5 rounded-lg shadow text-white">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="flex justify-start">
                  ...
                  <Link to="/roomservice/kamar" className="bg-slate-600 text-white px-4 py-2 rounded ml-3">
                    Kembali
                  </Link> 
                </div>
              </form>
...
export default RoomserviceKamarAdd;

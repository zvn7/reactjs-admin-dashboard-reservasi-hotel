...
const ResepsionisPengunjungAdd = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      window.location.href = "/resepsionis/pengunjung";
          ...
          <div className="ml-64 p-16 pt-0 w-full mt-28">
            <div className="bg-dark p-5 rounded-lg shadow text-white">
              ...
              <div className="d-flex justify-content-start">
                ...
                <Link to="/resepsionis/pengunjung" className="btn btn-secondary">
                  Kembali
                </Link>
              </div>
              </form>
...
export default ResepsionisPengunjungAdd;
